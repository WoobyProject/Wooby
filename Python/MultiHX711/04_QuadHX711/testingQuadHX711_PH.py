...
if ( abs(dfTestForTare["relativeVal_WU1"][0]) > threshold) or  (abs(dfTestForTare["relativeVal_WU2"][0]) > threshold)  or  (abs(dfTestForTare["relativeVal_WU3"][0]) > threshold)  or  (abs(dfTestForTare["relativeVal_WU4"][0]) > threshold)  :
    print("\n\nERROR WITH THE TARE !! ")
    ...
    print("Measure sensor 3: {}".format(dfTestForTare["relativeVal_WU3"][0]))
    print("Measure sensor 4: {}".format(dfTestForTare["relativeVal_WU4"][0]))

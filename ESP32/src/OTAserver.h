  ...
  */
  ...
  "<form name='loginForm'>"
      "<table width='20%' bgcolor='A09F9F' align='center'>"
          "<tr>"
              "<td colspan=2>"
                  "<center><font size=4><b>Wooby OTA login page</b></font></center>"
                  "<br>"
              "</td>"
              "<br>"
              "<br>"
  ...
  */
  ...
  bool setupOTA(){
    ...
    if (BF_WIFI){
      Serial.printf("\nWARNING: WiFi failed. OTA won't work.");
      return false;
    }

    /*use mdns for host name resolution*/
    if (!MDNS.begin(WLAN_HOSTNAME)) { //http://esp32.local
